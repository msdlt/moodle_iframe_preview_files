...
echo '<style type="text/css"> .que .formulation {background-color: #fff; border: 0px;} .que .info{display:none;} .que .content {margin: 0 0 0 0;} .que.shortanswer .answer input {width: 100%;} </style>';
